...
export default function MainContent(props) {
    ...
    const renderContainer = () => {
        ...
        <Resume skills={props.user.skills} technologies={props.user.technologies} links={props.user.links} user={props.user} educations={props.user.educations} technologies={props.user.technologies}/>
        ]
